...
gtk_tree_store_set (store, &parent_iter, COLUMN_TITLE,"다시 부르기", COLUMN_ARTIST, "김광석",
COLUMN_CATALOGUE, "A931001",-1);
...
(GTK_TREE_VIEW(view), COLUMN_TITLE, "제목",
renderer, "text", COLUMN_TITLE, NULL);
gtk_tree_view_insert_column_with_attributes
(GTK_TREE_VIEW(view), COLUMN_ARTIST, "아티스트",
renderer, "text", COLUMN_ARTIST, NULL);
gtk_tree_view_insert_column_with_attributes
(GTK_TREE_VIEW(view), COLUMN_CATALOGUE, "카탈로그", renderer, "text", COLUMN_CATALOGUE, NULL);
